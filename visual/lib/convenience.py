...
def create_plot_from_images(images: List[np.ndarray], grid_shape: Tuple[int, int], layout: str, mean_denorm: Optional[List[float]], std_denorm: Optional[List[float]], min_value: float, max_value: float, height: float) -> Figure:
